package io.papermc.plugin.tiler.world.mca.loader;
...
import io.papermc.plugin.tiler.world.nbt.NBTReader;
import io.papermc.plugin.tiler.world.nbt.NBTSkipper;
import io.papermc.plugin.tiler.world.mca.model.MCAChunk;
import io.papermc.plugin.tiler.world.mca.model.MCARegion;
import io.papermc.plugin.tiler.world.mca.model.MCASection;
...
public class MCAChunkLoader {
    ...
    public static int getPositionOffset(int[] offsets, int localX, int localZ) {
        int index = (localX % RegionConfig.CHUNK_SIDE) + (localZ % RegionConfig.CHUNK_SIDE) * RegionConfig.CHUNK_SIDE;
